...
namespace CliTestApp
{
    ...
    public static class FakeOrders
    {
        ...
        public static readonly Product[] PRODUCTS = new Product[] {
            ...
            new Product() {Code = "5388-4", Name = "Токсоплазмоза Ig G – ELISA", SampleCode = "SER", SampleName = "Serum"},
            new Product() {Code = "47308-2", Name = "Ехинококоза Ig G – ELISA", SampleCode = "SER", SampleName = "Serum"},
            new Product() {Code = "6563-1", Name = "Трихинелоза Ig G – ELISA", SampleCode = "SER", SampleName = "Serum"},
        };
