    ...
    public class Program
    {
        ...
        private static Order GetDemoOrder()
        {
            ...
            return new Order(
                ...
                {
                    Identifiers = new[] {
                        new Identifier() { Authority = Authorities.BG_GRAO, Value = "7505051234" } },
                    GivenName = "Борис",
                    MiddleName = "Иванов",
                    ...
                    IsMale = true,
                    Contacts = new[] {
                        new Contact() { Type = ContactTypes.PHONE, Value = "0878005006" } }
                },
                new[] {
                    new Service("14749-6", "Глюкоза"),
                    //new Service("54347-0", "Albumin")
                })
            {
                Samples = new[] {
                        new Sample("SERUM", null, "S05FT5") }
            };
